	...
	static public void main(String[] agrs){
	    ...
	    for(int i=0;i<n1;i++){
	        ...
	        for(int i=0;i<=1000;i++){
	        	arn.insertar(resultado1[i]); //insercion de elementos al azar
	        }
	        ...
	        for(int i=0;i<n2;i++){
		     ...
		     for(int i=0;i<100;i++){
			   arn.buscar(resultado2[i]); //busqueda de elementos al azar
			 }
		     long finish = System.currentTimeMillis() - start;
			 System.out.println("La busqueda para un ARN con llaves escogidas al azar demora "+finish+" ms");
